...
class TestGrad(unittest.TestCase):
    ...
    def test_dot(self):
        ...
        (gt_grad_x, gt_grad_y) = self.batched_jacobian(lambda x, y: x.dot(y), (x, y))
    ...
    def test_matrix_vector(self):
        ...
        (gt_grad_m, gt_grad_u) = self.batched_jacobian(lambda x, y: x @ y, (m, u))
    ...
    def test_angle_vector(self):
        ...
        (gt_grad_u, gt_grad_v) = self.batched_jacobian(
            lambda x, y: torch.atan2(torch.cross(x, y).norm(), x.dot(y)), (u, v)
        )
